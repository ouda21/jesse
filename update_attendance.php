        ...
        if(mysqli_num_rows($result)>0)
        {
            while($row=mysqli_fetch_assoc($result))
            {
                ...
                while($row1=mysqli_fetch_assoc($result1))
                {
                    ...
                    echo '<form class="form-inline form-group"  method="POST" action="php/update_attendance.php">
                    <div class="form-group mb-2">
                      <input type="hidden" name="student" class="form-control" id="staticEmail2" value="'.$stude.'">
                      <input type="hidden" name="unit" class="form-control" id="staticEmail2" value="'.$unit.'">
                      <input type="number" name="taught" class="form-control" id="staticEmail2" placeholder="Taught Hours">
                    </div>
                    &nbsp &nbsp &nbsp
                    <div class="form-group mb-2">
                      <input type="number" name="attended" class="form-control" id="staticEmail2" placeholder="Attended Hours">
                    </div> &nbsp &nbsp &nbsp
                    <button type="submit" name="attendance" class="btn btn-primary mb-2">Update</button>
                  </form>';
